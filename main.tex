...
\usepackage{amsmath}
\usepackage{amssymb}        % Hỗ trợ ký hiệu toán học (cho \mathbb)
...
\usepackage{amsmath} % only if not already loaded in main file
...
\include{Chapter3/chapter3.1}

\include{Chapter3/chapter3.2}
